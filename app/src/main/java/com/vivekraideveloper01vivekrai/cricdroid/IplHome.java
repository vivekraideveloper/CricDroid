 ...
 */
public class IplHome extends RecyclerView.Adapter<IplHome.ImageViewHolder> {

    private Context context;
    private List<Upload> list;
    private IplHome.OnItemClickListener mListener;

    public IplHome(Context context, List<Upload> list){
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_videos, parent, false);
        return new IplHome.ImageViewHolder(view);
    }
