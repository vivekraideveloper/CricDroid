 ...
 */
public class BblHome extends RecyclerView.Adapter<BblHome.ImageViewHolder> {

    private Context context;
    private List<Upload> list;
    private BblHome.OnItemClickListener mListener;

    public BblHome(Context context, List<Upload> list){
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new BblHome.ImageViewHolder(view);
    }
