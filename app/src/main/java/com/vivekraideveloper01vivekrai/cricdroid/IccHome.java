 ...
 */
public class IccHome extends RecyclerView.Adapter<IccHome.ImageViewHolder> {

    private Context context;
    private List<Upload> list;
    private IccHome.OnItemClickListener mListener;

    public IccHome(Context context, List<Upload> list){
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new IccHome.ImageViewHolder(view);
    }
