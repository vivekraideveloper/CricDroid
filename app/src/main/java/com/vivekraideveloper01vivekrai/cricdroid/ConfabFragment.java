...
public class ConfabFragment extends Fragment implements NewsAdapter.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        interstitialAd.setAdUnitId("ca-app-pub-2331594731643176/7373190776");
        interstitialAd2.setAdUnitId("ca-app-pub-2331594731643176/6862178595");
        interstitialAd3.setAdUnitId("ca-app-pub-2331594731643176/1286294573");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Confab");
        databaseReference.keepSynced(true);

        imageAdapter = new NewsAdapter(getActivity(), uploads);
