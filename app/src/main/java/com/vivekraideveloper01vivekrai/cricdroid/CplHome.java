 ...
 */
public class CplHome extends RecyclerView.Adapter<CplHome.ImageViewHolder> {

    private Context context;
    private List<Upload> list;
    private CplHome.OnItemClickListener mListener;

    public CplHome(Context context, List<Upload> list){
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new CplHome.ImageViewHolder(view);
    }
